...
![This image demonstrates part of a sample Terraform template for provisioning Azure Database for MySQL.](./media/sample-terraform-template.png "Azure Database for MySQL sample Terraform template")
